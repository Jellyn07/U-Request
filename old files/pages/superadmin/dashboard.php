...
<body>
    <div id="superadmin-menu"></div>
    <script src="../../js/admin-menu.js"></script>
    <p class="type">DASHBOARD /graph kung keri huhu para visualize</p>
    <div class="main">
        <div class="dashi1">
            <p class="dashi" id="gsup">MOTORPOOL PERSONNELS</p>
            <div class="desc"> 
...
<div class="recentrequests">
    <div class="rrhead">
        <select id="recent-title" name="recent-title" style="background-color: transparent; font-weight:bold;">
        <option value="reservations">RECENT RESERVATIONS</option>
        <option value="requests">RECENT REQUESTS</option>
        </select>
...
<script>
    ...
    const dropdown = document.getElementById('recent-title');
    const reservations = document.getElementById('reservations-section');
    const requests = document.getElementById('requests-section');
