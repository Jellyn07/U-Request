  ...
  <body class="bg-background text-text">
    ...
    <main class="">
      ...
      <div class="flex">
        ...
        <article class="mr-20 w-1/2 m-5 rounded-lg border border-gray-100 bg-white p-4 shadow-lg transition hover:shadow-red-500 sm:p-6">
      ...
      <!-- <div class="bg-primary text-background p-4 rounded mb-4">Repair Request</div>
      <div class="bg-primary text-background p-4 rounded mb-4">Vechicle Booking Request</div> -->
    </main>
