...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../css/MotorpoolAdmin/personnel.css">
...
<body>
    ...
    <div class="main">
        <p class="type">DRIVER</p>

        <div class="toolbar">

            <form method="GET" action="" style="display: flex; gap: 10px; align-items: center;" id="searchForm">
                <input type="search" placeholder="Search Driver" name="search" id="driversearch" value="<?php echo htmlspecialchars($searchTerm); ?>" oninput="handleRealTimeSearch()">
                <select class="filter" name="filter" id="filterSelect" onchange="handleRealTimeSearch()">
                    ...
                    <option value="Fixing" <?php echo ($_GET['filter'] ?? '') === 'Fixing' ? 'selected' : ''; ?>>Driving</option>
            ...
            <div style="display: flex; gap: 10px;">
                <button onclick="printSection('driver')" class="print"><img src="../../assets/icon/printing.png">&nbsp;Print</button>
                <button class="addDriver" id="adddriver"><img src="../../assets/icon/add.png">&nbsp;Add Driver</button>
            </div>
        </div>
...
<div id="driverModal" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.5); z-index:1000;">

    <div style="background:white; width:30vw; margin:10vw auto; padding:3vw; border-radius:0.5vw;">
        <h2>Driver Details</h2> <button onclick="closeModal()" id="moreExit"><img src="../../assets/icon/exit.png" alt="More" width="26"></button>
...
<div id="editDriverModal" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.5); z-index:1000;">
...
function showDriverModal(staff) {
    // Fill in static data
...
document.addEventListener('DOMContentLoaded', () => {
    const modal1 = document.getElementById('driverModal');
