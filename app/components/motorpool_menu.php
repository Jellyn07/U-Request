  ...
  <div class="flex flex-col flex-1">
    ...
    <nav class="flex-1 overflow-y-auto text-sm text-white mt-2">
      <ul class="space-y-2 p-2">
        ...
        <a href="../../shared/views/vehicle_request.php" class="flex items-center w-full p-2 rounded-lg hover:bg-accent transition gap-2">
        ...
        <a href="../../shared/views/schedules.php" class="flex items-center w-full p-2 rounded-lg hover:bg-accent transition gap-2">
