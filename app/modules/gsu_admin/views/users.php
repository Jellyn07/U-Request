                ...
                <?php foreach ($users as $user): ?>
                  <tr 
                    @click="selected = {
                      ...
                      officeOrDept: '<?= isset($user['officeOrDept']) ? htmlspecialchars($user['officeOrDept']) : 'Undefined' ?>',
        ...
        <div x-show="showDetails" x-cloak class="bg-white shadow rounded-lg p-4 max-h-[640px] overflow-y-auto">
          ...
          <form id="userForm" method="post" action="../../../controllers/UserAdminController.php" class="space-y-4">
            ...
            <div>
              ...
              <input type="text" :value="selected.requester_id" disabled class="w-full view-field cursor-not-allowed">
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label class="text-sm text-gray-600">First Name</label>
                <input type="text" :value="selected.firstName" disabled class="w-full view-field cursor-not-allowed">
              </div>
              <div>
                <label class="text-sm text-gray-600">Last Name</label>
                <input type="text" :value="selected.lastName" disabled class="w-full view-field cursor-not-allowed">
              </div>
            </div>

            <div>
              <label class="text-sm text-gray-600">Program/Office</label>
              <input type="text" :value="selected.officeOrDept" disabled class="w-full view-field cursor-not-allowed">
            </div>
